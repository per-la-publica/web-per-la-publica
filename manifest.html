...
<ul id="valors">
	...
	<li><strong>Valorem la participació de tota la comunitat</strong>, per sobre de l’agilitat en la presa de decisions.</li>
	<li><strong>Valorem la transparència</strong>, per sobre de la imatge d’excel·lència i del prestigi.</li>
</ul>
...
<script type="text/javascript">
    $('#valors li').css("line-height","1.75");
</script>
